...
import { foxLevel } from '../src/fox/play.ts'
import { luckycatLevel } from '../src/luckycat/play.ts'
import { skadiLevel } from '../src/skadi/play.ts'
import { feiduduLevel } from '../src/feidudu/play.ts'
import { dinosaurLevel } from '../src/dinosaur/play.ts'
...
const forms = [
  ...
  ['fox', foxLevel, 'empty', 'unknown'],
  ['luckycat', luckycatLevel, 'empty', 'unknown'],
  ['skadi', skadiLevel, 'empty', 'unknown'],
  ['feidudu', feiduduLevel, 'empty', 'unknown'],
  ['dinosaur', dinosaurLevel, 'empty', 'unknown']
] as const
